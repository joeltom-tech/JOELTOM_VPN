...
# Rôle : Installation automatisée du Bot Telegram JOELTOM VPN

echo -e "\e[32m[+] Démarrage de l'installation du Bot Telegram JOELTOM VPN...\e[0m"
...
# wget -q -O /root/doty_bot/main.py https://raw.githubusercontent.com/joeltom-tech/JOELTOM_VPN/main/joeltom_bot_source/main.py
# wget -q -O /root/doty_bot/core/xray_handler.py https://raw.githubusercontent.com/joeltom-tech/JOELTOM_VPN/main/joeltom_bot_source/core/xray_handler.py
# wget -q -O /root/doty_bot/core/ssh_handler.py https://raw.githubusercontent.com/joeltom-tech/JOELTOM_VPN/main/joeltom_bot_source/core/ssh_handler.py
# wget -q -O /root/doty_bot/utils/qr_generator.py https://raw.githubusercontent.com/joeltom-tech/JOELTOM_VPN/main/joeltom_bot_source/utils/qr_generator.py
...
[Unit]
Description=JOELTOM VPN Telegram Bot
