...
printf '%b\n' "${K_GREEN}╭────────────────────────────────────────────────────────────────────┐${K_RESET}"
printf '%b\n' "│ ${K_CYAN}[01]${K_RESET} MENU SSH VIP      ${K_CYAN}[10]${K_RESET} MENU PORT         ${K_CYAN}[19]${K_RESET} CERT SSL          │"
printf '%b\n' "│ ${K_CYAN}[02]${K_RESET} MENU VMESS        ${K_CYAN}[11]${K_RESET} SPEEDTEST         ${K_CYAN}[20]${K_RESET} INSTALL UDP       │"
printf '%b\n' "│ ${K_CYAN}[03]${K_RESET} MENU VLESS        ${K_CYAN}[12]${K_RESET} RUNNING CHECK     ${K_CYAN}[21]${K_RESET} CLEAR CACHE       │"
printf '%b\n' "│ ${K_CYAN}[04]${K_RESET} MENU TROJAN       ${K_CYAN}[13]${K_RESET} CLEAR LOG         ${K_CYAN}[22]${K_RESET} CHECK BANDWIDTH   │"
printf '%b\n' "│ ${K_CYAN}[05]${K_RESET} MENU SOCKS        ${K_CYAN}[14]${K_RESET} CREATE BACKUP     ${K_CYAN}[23]${K_RESET} MENU BOT VIP      │"
printf '%b\n' "│ ${K_CYAN}[06]${K_RESET} MENU ZIVPN        ${K_CYAN}[15]${K_RESET} REBOOT VPS        ${K_CYAN}[24]${K_RESET} WEB PANEL         │"
printf '%b\n' "│ ${K_CYAN}[07]${K_RESET} CHECK RAM/CPU     ${K_CYAN}[16]${K_RESET} FAST DNS          ${K_CYAN}[25]${K_RESET} V2RAY-DNS         │"
printf '%b\n' "│ ${K_CYAN}[08]${K_RESET} DELETE ALL EXP    ${K_CYAN}[17]${K_RESET} SET DOMAIN        ${K_CYAN}[26]${K_RESET} UPDATE JOELTOM  │"
printf '%b\n' "│ ${K_CYAN}[09]${K_RESET} AUTO REBOOT       ${K_CYAN}[18]${K_RESET} RESTART VPS       ${K_CYAN}[27]${K_RESET} UNINSTALL JOELTOM│"
printf '%b\n' "${K_GREEN}╰────────────────────────────────────────────────────────────────────┘${K_RESET}"
k_sep K_MAGENTA
